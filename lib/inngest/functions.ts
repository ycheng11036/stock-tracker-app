  ...
  async ({ event, step }) => {
    ...
    await step.run("send-welcome-email", async () => {
      ...
      const introText =
        ...
        "Thanks for joining Signalist. This is a tool for tracking market and make smarter moves.";
...
export const sendDailyNewsSummary = inngest.createFunction(
  ...
  async ({ step }) => {
    ...
    return { success: true, message: "Daily news summary send successfully." };
  }
);
